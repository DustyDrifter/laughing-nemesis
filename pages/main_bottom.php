...
<div class="main_top_menu">
    <div class="main_short">
        ...
        ?>
        <div class="_shortcut_sett<?php if ($user_level != "Super Administrator") {
            echo "_adm";
        }?>">
            <span><?php if ($user_level == "Super Administrator") {
                echo '<a href="content.php?include=admserver">';
            }?><?php if ($user_level != "Super Administrator") {
                echo "<p>(";
            }?><?php echo $messages["364"];?><?php if ($user_level != "Super Administrator") {
                echo ")</p>";
            }?><?php if ($user_level == "Super Administrator") {
                echo '</a>';
            }?></span>
        </div>
        <div class="_shortcut_radi<?php if ($user_level != "Super Administrator") {
            echo "_adm";
        }?>">
            <span><?php if ($user_level == "Super Administrator") {
                echo '<a href="content.php?include=admradio">';
            }?><?php if ($user_level != "Super Administrator") {
                echo "<p>(";
            }?><?php echo $messages["365"];?><?php if ($user_level != "Super Administrator") {
                echo ")</p>";
            }?><?php if ($user_level == "Super Administrator") {
                echo '</a>';
            }?></span>
        </div>
        <div class="_shortcut_cust<?php if ($user_level != "Super Administrator") {
            echo "_adm";
        }?>">
            <span><?php if ($user_level == "Super Administrator") {
                echo '<a href="content.php?include=admuser">';
            }?><?php if ($user_level != "Super Administrator") {
                echo "<p>(";
            }?><?php echo $messages["366"];?><?php if ($user_level != "Super Administrator") {
                echo ")</p>";
            }?><?php if ($user_level == "Super Administrator") {
                echo '</a>';
            }?></span>
